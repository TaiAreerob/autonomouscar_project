...
BehaviorGen::BehaviorGen()
{
  ...
  sub_max_velocity = nh.subscribe("/op_planner_max_velocity", 1, &BehaviorGen::callbackMaxVelocity, this);
...
/* tw */
void BehaviorGen::callbackMaxVelocity(const std_msgs::Float64ConstPtr& msg) {
  m_BehaviorGenerator.ChangeMaxVelocity(msg->data);
}
